...
final readonly class Story
{
    ...
    /**
     * @param  array{title: string, hook: string, description: string, tags: list<string>, thumbnailPrompt: string, scenes: list<array{order: int, narration: string, imagePrompt: string, soundEffect: ?string, visualBeats?: list<string>}>, pronunciations?: list<array{term: string, phonetic: string}>, visualBible?: array<string, mixed>}  $data
     */
    ...
    /**
     * @return array{title: string, hook: string, description: string, tags: list<string>, thumbnailPrompt: string, scenes: list<array{order: int, narration: string, imagePrompt: string, soundEffect: ?string, visualBeats: list<string>}>, pronunciations: list<array{term: string, phonetic: string}>, visualBible?: array{setting: string, era: string, timeOfDay: string, weather: string, palette: list<string>, characters: list<array{slug: string, descriptor: string, framingRule: string}>, recurringObjects: list<array{slug: string, descriptor: string}>, avoid: list<string>}}
     */
